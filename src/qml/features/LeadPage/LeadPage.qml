...
InnerPage {
    ...
    Component {
        id: propertiesList
        LeadPropertiesList {
            onOpen: (propertyId)=>leadPage.parentStack.push(propertyPageComponent, {propertyId})
        }
    }
    Component {
        id: communitiesList
        LeadCommunitiesList {
            onOpen: (communityId)=>leadPage.parentStack.push(communityPageComponent, {communityId})
        }
    }
    // Component {
    //     id: devicesList
    ...
    TabView {
        ...
        currentIndex: 0
        width: parent.width
        tabs: [qsTr("Communities"), qsTr("Properties"), /*qsTr("Devices"), qsTr("Activties")*/]
        tabViews: [communitiesList, propertiesList, /*devicesList, activtiesList*/]
    }
    ...
    Component {
        ...
        Loader {
            property var parentStack: leadPage.parentStack
